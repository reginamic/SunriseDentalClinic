...
public class ClinicReport {
    ...
    public ClinicReport() {
        ...
        this.dentistWorkload = new ArrayList<>();
        this.treatmentDemand = new ArrayList<>();
    }
    ...
    public List<DentistWorkload> getDentistWorkload() {
        return dentistWorkload;
    }

    public void setDentistWorkload(List<DentistWorkload> dentistWorkload) {
        this.dentistWorkload = dentistWorkload;
    }

    public List<TreatmentDemand> getTreatmentDemand() {
        return treatmentDemand;
    }

    public void setTreatmentDemand(List<TreatmentDemand> treatmentDemand) {
        this.treatmentDemand = treatmentDemand;
    }
